      ...
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="sr-only">
            {item ? `${item.name} — ${item.issuer}` : "Certyfikaty"}
          </Dialog.Title>

          {item && (
            <div className="relative flex h-full max-h-[85vh] w-full max-w-3xl flex-col items-center justify-center">
              {/* Counter */}
              <div
                aria-live="polite"
                aria-atomic="true"
              ...
              <Dialog.Close
                ...
                aria-label="Zamknij galerię certyfikatów"
              >
                <X size={14} />
              </Dialog.Close>
