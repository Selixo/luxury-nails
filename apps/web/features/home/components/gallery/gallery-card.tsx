  ...
  return (
    ...
    >
      ...
      {item.src ? (
        ...
        /* Placeholder — podmień src w GALLERY_ITEMS gdy będziesz mieć zdjęcia */
        <div
          aria-hidden="true"
        ...
        >
          <span className="font-display text-5xl text-white/[0.05] select-none">
            ✦
          </span>
        </div>
      )}
      ...
      >
        <div className="translate-y-3 opacity-0 transition-[opacity,transform] duration-300 group-hover:translate-y-0 group-hover:opacity-100">
          <p className="mb-1 text-[10px] font-light tracking-[0.25em] text-gold uppercase">
